...
.pricebol {
    background: url("images/pricebol_big.png") no-repeat scroll 50% 0 transparent !important;
    top: 30px;
    height: 68px;
    padding-top: 8px;
    position: absolute;
...
// Build the desired HTML code for each productitem and append it to $results
 	...
 	$resultlist.= '<li class="more" id="'.$number.'">
  <a class="product" href="'.$externalurl.'">
  <span class="imageBox">
  <img alt="'.$title.'" src="'.$thumbnailurl.'">
  <div class="pricebol two_digits">
  '.$listpricediv.'
  <div class="newprice">'.$firstprice.'</div>
  <sup>'.$secondprice.'</sup>
  </div>
  </span>
